      ...
      <View style={{flex:1, justifyContent:'center', alignItems:'center', backgroundColor:'#f4f7fe'}}>
        <View style={{alignItems:'center', marginBottom:30}}>
          <View style={{ backgroundColor:'#fff', borderRadius:99, padding:16, elevation:7, shadowColor:'#6c63ff', shadowOpacity:0.17, shadowRadius:20 }}>
            <Text style={{ fontSize:54, color:'#6c63ff' }}>{bannerIcon}</Text>
          </View>
        ...
        <ActivityIndicator size="large" color="#e17055" style={{marginTop:10}} />
        <Text style={{color:'#bfc9ea', fontSize:16, marginTop:20, fontFamily:'sans-serif'}}>Loading...</Text>
      </View>
    );
  }
